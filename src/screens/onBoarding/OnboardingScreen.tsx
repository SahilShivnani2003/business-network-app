...
const slides = [
    {
        ...
        description:
            'Join thousands of verified business owners and entrepreneurs who are growing together through the power of trusted connections.',
    ...
    },
    {
        ...
        description:
            'Access verified business leads and client requirements directly. Stop chasing cold leads — get warm, relevant opportunities.',
        bg: '#0D2E6E',
        accent: '#FF8F00',
    },
    {
        ...
        description:
            'Every member is verified. Build authentic business relationships with trustworthy partners, clients, and collaborators.',
        bg: '#1A1060',
        accent: Colors.accent,
    },
    {
        ...
        description:
            'Be part of industry WhatsApp groups, offline networking events, and online webinars. Expand your reach nationwide.',
        bg: '#0B3A2D',
        accent: '#34D399',
    },
];
...
const OnboardingScreen: React.FC<Props> = ({ navigation }) => {
    const { isAuthenticated, loadCompany } = useAuthStore();
                ...
                {slides.map((_, i) => {
                    ...
                    return (
                        <Animated.View
                            ...
                            style={[
                                styles.dot,
                                { width: dotWidth, opacity: dotOpacity, backgroundColor: accent },
                            ]}
                        />
                    );
                })}
            ...
            <View style={styles.bottomSection}>
                ...
                {currentIndex === slides.length - 1 && (
                    <View style={styles.authRow}>
                        ...
                        <TouchableOpacity
                            style={[styles.registerBtn, { borderColor: `${Colors.white}50` }]}
